...
namespace WarfrontDirector
{
    ...
    public sealed class WarfrontDirectorPlugin : BaseUnityPlugin
    {
        ...
        internal static ConfigEntry<float> SiegeEscalationMultiplier { get; private set; }
        internal static ConfigEntry<float> ZoneShrinkMinPercent { get; private set; }
        ...
        private void BindConfig()
        {
            ...
            SiegeEscalationMultiplier = Config.Bind("Teleporter", "Siege Escalation Multiplier", 1f, "Global scalar on siege escalation effects (pulse interval, breather, spawns). Higher = harder.");
            ZoneShrinkMinPercent = Config.Bind("Teleporter", "Zone Shrink Min Percent", 55f, "Minimum teleporter safe-zone radius as percentage of original at full charge.");
